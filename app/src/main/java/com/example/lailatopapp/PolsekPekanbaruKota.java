    ...
    private void tampilankanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String nomortel = "tel:0811752110";
            ...
            } else if (pilihan.equals("SMS Center"))
            {
                ...
                a.setData(Uri.parse("sms:0811752110"));
                a.putExtra("sms_body", smsText);
            }else if (pilihan.equals("Driving Direction"))
            {
                String lokasirs = "https://www.google.com/maps/dir//Polsek+Pekan+Baru+Kota,+Jl.+Jend.+Sudirman+No.444,+Tanah+Datar,+Kec.+Pekanbaru+Kota,+Kota+Pekanbaru,+Riau+28115/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x31d5ac1b1fc8600b:0x3fc69a78198ae50c?sa=X&ved=2ahUKEwimlIGf2b32AhV963MBHSAPChcQ48ADegQIAhBP";
